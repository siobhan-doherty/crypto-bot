...
PLOT_LAYOUT = {
    ...
    "height": 500,
    "hovermode": "x unified",
    "hoverlabel": {"font": {"color": COLORS["text"]}, "bgcolor": COLORS["panel"]},
    "legend": {
        "font": {"color": COLORS["text"]},
...
CANDLESTICK = {"increasing": "#00bc8c", "decreasing": "#e74c3c"}

LINE_PLOT = {"line_color": COLORS["primary"], "line_width": 2}

VOLUME_PLOT = {"bar_color": COLORS["primary"], "line_width": 2}
