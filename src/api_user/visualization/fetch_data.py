...
def _call_api(endpoint: str, params: Optional[dict] = None) -> Dict[str, Any]:
    """Make GET request to FastAPI endpoint with retries."""
...
def get_available_date_range() -> Tuple[datetime, datetime]:
    """
    Fetch available date range from FastAPI endpoint.
...
def fetch_historical_data(
    ...
    """
    Fetch historical OHLCV data from FastAPI endpoint.
    Returns pandas DataFrame with columns: open_datetime, close, volume, etc.
    """
