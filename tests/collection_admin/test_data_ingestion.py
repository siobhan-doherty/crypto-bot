...
# disable Kafka mocks from conftest
os.environ["E2E_TEST"] = "1"
# mock Spark and findspark globally
sys.modules["findspark"] = MagicMock()
pyspark = ModuleType("pyspark")
pyspark_sql = ModuleType("pyspark.sql")
pyspark_sql.Row = MagicMock()  # type: ignore[attr-defined]
pyspark_sql.SparkSession = MagicMock()  # type: ignore[attr-defined]
...
pyspark_sql.SparkSession.builder = mock_builder  # type: ignore[attr-defined]
